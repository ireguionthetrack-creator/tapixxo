      ...
      <section className="mx-auto max-w-3xl px-5 py-14 sm:py-20">
        <article className="tapixxo-panel rounded-3xl p-7 sm:p-10">
          ...
          <div className="mt-8 space-y-6 text-sm leading-7 text-gray-300">
            ...
            <section><h2 className="font-semibold text-white">Compra de placas</h2><p>Las placas físicas se compran en la Store. La disponibilidad se confirma durante el procesamiento del pago; cada placa queda vinculada a un único código existente.</p></section>
          ...
          <Link href="/store" className="mt-9 inline-flex rounded-xl bg-orange-400 px-5 py-3 font-semibold text-black hover:bg-orange-300">Volver a la Store</Link>
        </article>
      </section>
    </main>
  );
